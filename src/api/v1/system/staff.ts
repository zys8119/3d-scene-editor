...
/** 获取已绑定负责人列表 */
export function getOrgAdmin(data: object, page: PageMap, organizationId: string) {
    return request<List<Staff>>({
...
/** 批量设置状态 */
export function updateEffect(id_list: string[], is_effect: boolean, organizationId: string) {
    return request({
        method: 'post',
