...
export function resetPassword(data: {old_password: string, new_password: string}) {
    return request({
        method: 'patch',
...
export function resetUsersPassword(data: {id_list: string[], admin_password: string, new_password: string}) {
    return request({
        method: 'patch',
