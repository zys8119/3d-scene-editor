<template>
    <n-search-table-page ref="searchTablePageRef" :data-api="api.v1.test.list" :data-table-props="{columns: columns}" @search="a">
        ...
        <template #table_gender="{row}">
            <n-tag v-if="row.gender === 1" type="primary" size="small">男</n-tag>
