...
var _gdtjsapi = require('gdt-jsapi'); var _gdtjsapi2 = _interopRequireDefault(_gdtjsapi);
...
function getAuthCode() {
  ...
  return new Promise((resolve, reject) => {
    try {
      _gdtjsapi2.default.ready(() => {
        _gdtjsapi2.default.getAuthCode({}).then(async (result) => {
          if (result) {
...
exports.createBaseBurialPointZzd = createBaseBurialPoint; exports.createUserInfoBurialPointZzd = createUserInfoBurialPoint; module.exports = src_default; exports.getAuthCodeZzd = getAuthCode; exports.utils = utils_default; exports.zwlogGlobalZlb = zwlogGlobal;
