...
export declare type RequestResponseType<Config extends AxiosRequestConfig, T extends any> = Config['raw'] extends true ? T : (Config['responseType'] extends "arraybuffer" | "blob" | "document" | "text" | "stream" ? T : ResponseType<T>);
