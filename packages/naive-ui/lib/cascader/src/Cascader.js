...
exports.cascaderProps = Object.assign(
...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props, { slots }) {
        ...
        const loadingKeySetRef = (0, vue_1.ref)(/* @__PURE__ */ new Set());
        ...
        const checkedKeysRef = (0, vue_1.computed)(
            () => mergedKeysRef.value.checkedKeys
        );
        const indeterminateKeysRef = (0, vue_1.computed)(
                ...
                try {
                    ...
                    doUpdateValue(
                        ...
                        checkedKeys.map((checkedKey) => {
                            var _a2;
                            return (0, utils_1.getRawNodePath)(
                ...
                if (mergedCheckStrategyRef.value === 'child') {
                    ...
                    if (
                        ...
                        doUpdateValue(
                            key,
                            tmNode.rawNode,
                            (0, utils_1.getRawNodePath)(
                                getPath(key).treeNodePath
                            )
                        );
                    } else {
                        return false;
        ...
        const cssVarsRef = (0, vue_1.computed)(() => {
            ...
            return {
                ...
                '--n-menu-mask-color': (0, seemly_1.changeColor)(menuColor, {
                    alpha: 0.75,
                }),
