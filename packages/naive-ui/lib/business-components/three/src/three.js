...
const { useWindowSize, useElementSize } = require('@vueuse/core');
var __createBinding =
...
exports.emits =
    exports.propsBaseThree =
    exports.BaseThreeClass =
    exports.convertFont =
        void 0;
const three_1 = require('three');
const THREE = __importStar(require('three'));
const lodash_1 = require('lodash');
const WebGL_js_1 = __importDefault(
    require('three/examples/jsm/capabilities/WebGL.js')
);
...
const VertexNormalsHelper_js_1 = require('three/examples/jsm/helpers/VertexNormalsHelper.js');
const FontLoader_js_1 = require('three/examples/jsm/loaders/FontLoader.js');
const TextGeometry_js_1 = require('three/examples/jsm/geometries/TextGeometry.js');
const GLTFLoader_js_1 = require('three/examples/jsm/loaders/GLTFLoader.js');
const stats_module_js_1 = __importDefault(
    require('three/examples/jsm/libs/stats.module.js')
);
...
const convertFont = function (font, text, outJs) {
...
class BaseThreeClass {
    ...
    setMouseController() {
        this.controls = new OrbitControls_js_1.OrbitControls(
            this.camera,
    ...
    checkWebGL(callback) {
        if (WebGL_js_1.default.isWebGLAvailable()) {
            ...
            this.vm.exposed.baseTheeEl.value.appendChild(
                WebGL_js_1.default.getWebGLErrorMessage()
            );
        }
    }
    ...
    setCoordinateLine(lingMax = 100) {
        ...
        const helper1 = new VertexNormalsHelper_js_1.VertexNormalsHelper(
            box,
            2,
            65280
        );
    ...
    addText(text, fontName, map) {
        return __awaiter(this, void 0, void 0, function* () {
            const box = new TextGeometry_js_1.TextGeometry(text, {
    ...
    transformControls() {
        const control = new TransformControls_js_1.TransformControls(
            this.camera,
            this.renderer.domElement
        );
    ...
    downloadFonts(fontUrl, familyName) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const fontArrayBuffer = (0, opentype_js_1.parse)(
            ...
            const fontJson = (0, exports.convertFont)(fontArrayBuffer);
            const fontInfo = {
                fontJson,
                font: new FontLoader_js_1.FontLoader().parse(fontJson),
            };
            this.fonts.set(
    ...
    watchUpDate() {
        if (!this.isWatchUpDate) {
            ...
            watchEffect(() => {
                this.vm.exposed.initializationData.value = (0, lodash_1.merge)(
    ...
    addGLTFLoader(url, name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const gltf = yield new GLTFLoader_js_1.GLTFLoader().loadAsync(url);
...
exports.BaseThreeClass = BaseThreeClass;
exports.propsBaseThree = {
    modelValue: {},
    fov: {},
    near: {},
...
const three3D = (0, vue_1.defineComponent)({
    name: 'Three',
    props: exports.propsBaseThree,
    emits: exports.emits,
    setup(props, ctx) {
