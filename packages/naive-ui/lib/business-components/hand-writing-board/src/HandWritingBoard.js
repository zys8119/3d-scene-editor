const { useResizeObserver, useEventListener } = require('@vueuse/core');
...
exports.handWritingBoardProp = void 0;
const vue_1 = require('vue');
const _mixins_1 = require('../../../_mixins');
const core_1 = require('@vueuse/core');
const index_cssr_1 = __importDefault(
    require('../../hand-writing-board/src/styles/index.cssr')
);
const light_1 = __importDefault(require('../styles/light'));
exports.handWritingBoardProp = Object.assign(
...
const HandWritingBoard = (0, vue_1.defineComponent)({
    name: 'HandWritingBoard',
    props: exports.handWritingBoardProp,
    setup(props) {
        const { mergedClsPrefixRef } = (0, _mixins_1.useConfig)(props);
        const containRef = (0, vue_1.ref)();
        const { width, height } = (0, core_1.useElementSize)(containRef);
        const canvas = (0, vue_1.ref)();
        const hasDrew = (0, vue_1.ref)(false);
        const points = (0, vue_1.ref)([]);
        const context = (0, vue_1.ref)(null);
        const startX = (0, vue_1.ref)(0);
        const startY = (0, vue_1.ref)(0);
        const isDrawing = (0, vue_1.ref)(false);
        const rate = (0, vue_1.ref)(1);
        const drawing = (0, vue_1.ref)(false);
        let historyObj = { x: -1, y: -1 };
        let historyWidth = 0;
        let historyTime = 0;
        const drawStartPoint = (0, vue_1.ref)([0, 0]);
        const drawMovePoint = (0, vue_1.ref)([0, 0]);
...
exports.default = HandWritingBoard;
