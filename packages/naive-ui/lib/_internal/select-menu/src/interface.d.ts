...
export declare const internalSelectionMenuInjectionKey: globalThis.InjectionKey<InternalSelectMenuInjection>;
export declare const internalSelectionMenuBodyInjectionKey: globalThis.InjectionKey<
