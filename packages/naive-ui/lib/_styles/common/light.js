...
const derived = Object.assign(
    Object.assign({ name: 'common' }, _common_1.default),
    {
        ...
        iconColorHover: (0, seemly_1.scaleColor)(neutral(base.alpha4), {
            lightness: 0.75,
        }),
        iconColorPressed: (0, seemly_1.scaleColor)(neutral(base.alpha4), {
            lightness: 0.9,
        }),
        ...
        clearColorHover: (0, seemly_1.scaleColor)(neutral(base.alpha4), {
            lightness: 0.75,
        }),
        clearColorPressed: (0, seemly_1.scaleColor)(neutral(base.alpha4), {
            lightness: 0.9,
        }),
