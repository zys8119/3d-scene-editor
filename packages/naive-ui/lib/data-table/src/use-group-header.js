        ...
        for (const column of columns2) {
            if ('children' in column) {
                ...
                cols.push({
                    ...
                    style: (0, utils_1.createCustomWidthStyle)(
                        column,
                        key !== void 0
                            ? (0, _utils_1.formatLength)(getResizableWidth(key))
                            : void 0
                    ),
                    column,
                });
...
function useGroupHeader(props, getResizableWidth) {
    const rowsAndCols = (0, vue_1.computed)(() =>
    ...
    return {
        ...
        hasEllipsisRef: (0, vue_1.computed)(
            () => rowsAndCols.value.hasEllipsis
        ),
        dataRelatedColsRef: (0, vue_1.computed)(
            () => rowsAndCols.value.dataRelatedCols
        ),
    };
}
