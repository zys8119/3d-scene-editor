...
declare const _default: import('vue').DefineComponent<
    ...
    },
    {
        ...
        showPopover: globalThis.Ref<boolean>;
        mergedRenderFilter: globalThis.ComputedRef<
            import('../interface').RenderFilter | undefined
        >;
        filterMultiple: globalThis.ComputedRef<boolean>;
        mergedFilterValue: globalThis.ComputedRef<
            FilterOptionValue | FilterOptionValue[] | null
        >;
        filterMenuCssVars: globalThis.Ref<import('vue').CSSProperties>;
        handleFilterChange: (
