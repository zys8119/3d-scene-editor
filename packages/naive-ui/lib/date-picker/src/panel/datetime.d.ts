...
declare const _default: import('vue').DefineComponent<
    ...
    },
    {
        ...
        monthArray: globalThis.ComputedRef<import('../utils').MonthItem[]>;
        yearArray: globalThis.ComputedRef<import('../utils').YearItem[]>;
        quarterArray: globalThis.ComputedRef<import('../utils').QuarterItem[]>;
