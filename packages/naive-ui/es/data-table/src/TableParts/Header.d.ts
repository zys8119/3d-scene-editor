...
declare const _default: import('vue').DefineComponent<
    ...
    {
        cellElsRef: globalThis.Ref<Record<ColumnKey, HTMLTableCellElement>>;
        componentId: string;
        ...
        allRowsChecked: globalThis.Ref<boolean>;
        someRowsChecked: globalThis.Ref<boolean>;
        rows: globalThis.Ref<import('../use-group-header').RowItem[][]>;
        cols: globalThis.Ref<import('../use-group-header').ColItem[]>;
        ...
        checkOptions: globalThis.Ref<
            | import('../interface').DataTableSelectionOptions<
                  import('../interface').InternalRowData
              >
            | undefined
        >;
        mergedTableLayout: globalThis.Ref<'fixed' | 'auto'>;
        headerCheckboxDisabled: globalThis.Ref<boolean>;
