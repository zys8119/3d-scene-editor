...
import { proFormLight } from '../business-components/pro-form/styles';
import { proCheckboxLight } from '../business-components/pro-checkbox/styles';
import { qrCodeLight } from '../qrCode/styles';
import { tourLight } from '../business-components/tour/styles';
import { notificationBarLight } from '../notification-bar/styles';
import { mapLight } from '../business-components/map/styles';
...
import { popDialogLight } from '../business-components/pop-dialog/styles';
import { progressLight } from '../progress/styles';
import { proUploadLight } from '../business-components/pro-upload/styles';
import { radioLight } from '../radio/styles';
import { rateLight } from '../rate/styles';
import { resultLight } from '../result/styles';
import { rotateAlbumLight } from '../business-components/rotate-album/styles';
import { rowLight } from '../legacy-grid/styles';
import { scrollbarLight } from '../_internal/scrollbar/styles';
import { scrollListLight } from '../business-components/scroll-list/styles';
import { searchTablePageLight } from '../business-components/search-table-page/styles';
...
import { tagSelectLight } from '../tag-select/styles';
...
import { cascadeMenuLight } from '../business-components/cascade-menu/styles';
import { handWritingBoardLight } from '../business-components/hand-writing-board/styles';
import { proEditorLight } from '../business-components/pro-editor/styles';
import { threeLight } from '../business-components/three/styles';
export const lightTheme = {
    name: 'light',
    ProForm: proFormLight,
    ProCheckbox: proCheckboxLight,
    QrCode: qrCodeLight,
    Tour: tourLight,
    NotificationBar: notificationBarLight,
    Map: mapLight,
    common: commonLight,
    Alert: alertLight,
    Anchor: anchorLight,
    ...
    HandWritingBoard: handWritingBoardLight,
    Icon: iconLight,
    ...
    PopDialog: popDialogLight,
    Popover: popoverLight,
    Popselect: popselectLight,
    Progress: progressLight,
    ProEditor: proEditorLight,
    ProUpload: proUploadLight,
    Radio: radioLight,
    Rate: rateLight,
    Row: rowLight,
    RotateAlbum: rotateAlbumLight,
    Result: resultLight,
    SearchTablePage: searchTablePageLight,
    Scrollbar: scrollbarLight,
    ScrollList: scrollListLight,
