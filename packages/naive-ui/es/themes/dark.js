...
import { proFormDark } from '../business-components/pro-form/styles';
import { proCheckboxDark } from '../business-components/pro-checkbox/styles';
import { qrCodeDark } from '../qrCode/styles';
import { tourDark } from '../business-components/tour/styles';
import { notificationBarDark } from '../notification-bar/styles';
import { mapDark } from '../business-components/map/styles';
...
import { popDialogDark } from '../business-components/pop-dialog/styles';
...
import { rotateAlbumDark } from '../business-components/rotate-album/styles';
import { rowDark } from '../legacy-grid/styles';
import { scrollbarDark } from '../_internal/scrollbar/styles';
import { scrollListDark } from '../business-components/scroll-list/styles';
import { searchTablePageDark } from '../business-components/search-table-page/styles';
...
import { tagSelectDark } from '../tag-select/styles';
...
import { cascadeMenuDark } from '../business-components/cascade-menu/styles';
import { handWritingBoardDark } from '../business-components/hand-writing-board/styles';
import { proUploadDark } from '../business-components/pro-upload/styles';
import { proEditorDark } from '../business-components/pro-editor/styles';
import { threeDark } from '../business-components/three/styles';
export const darkTheme = {
    name: 'dark',
    ProForm: proFormDark,
    ProCheckbox: proCheckboxDark,
    QrCode: qrCodeDark,
    Tour: tourDark,
    NotificationBar: notificationBarDark,
    Map: mapDark,
    common: commonDark,
    Alert: alertDark,
    Anchor: anchorDark,
    ...
    HandWritingBoard: handWritingBoardDark,
    Icon: iconDark,
    ...
    PopDialog: popDialogDark,
    Popover: popoverDark,
    Popselect: popselectDark,
    Progress: progressDark,
    ProEditor: proEditorDark,
    ProUpload: proUploadDark,
    Radio: radioDark,
    Rate: rateDark,
    Result: resultDark,
    Row: rowDark,
    RotateAlbum: rotateAlbumDark,
    SearchTablePage: searchTablePageDark,
    Scrollbar: scrollbarDark,
    ScrollList: scrollListDark,
    Select: selectDark,
